...
if __name__ == "__main__":
    ...
    while True:
        ...
        #Apre lo streaming e lo chiude alla pressione di un tasto
        #print("Inizializzazione streaming video")
        ...
        if True == True:
            ...
            """print(f"theta = {theta}")    NON FUNZIONA!!!
            print(f"prec = {prec}")
            print(f"Somma = {theta + prec}")
            if prec + theta > 1 or prec + theta < -1:
                if theta > SX_THETA:
