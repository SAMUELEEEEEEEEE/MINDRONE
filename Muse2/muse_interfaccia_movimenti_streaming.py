...
#Librerie intefaccia grafica
import PySimpleGUI as sg

#Libreria per il QR Code
...
layout = [[sg.Text('MINDRONE', font=("Helvetica", 30))], [sg.Text('Percentuale batteria:', font=("Helvetica", 15))], [sg.Text(battery_status, font=("Helvetica", 15), key='-PERC-')]]
window = sg.Window("Main Menu", layout, element_justification="center", size=(700, 200))
        ...
        while True:
            ...
            try:
                ...
                if data:
                    ...
                    while True:
                        _, _, alpha = museDxSx()
                        if alpha > FW_ALPHA or alpha < RW_ALPHA:
                            break
                    imageviewed = True
...
if __name__ == "__main__":
    ...
    while True:
        ...
        battery_status = my_drone.get_battery()
        window['-PERC-'].update(battery_status)
        window.refresh()
